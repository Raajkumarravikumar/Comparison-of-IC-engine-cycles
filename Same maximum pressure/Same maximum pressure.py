# COMPARISON OF OTTO CYCLE, DIESEL CYCLE AND DUAL CYCLE EFFICIENCY UNDER SAME MAXIMUM PRESSURE AND HEAT INPUT
print("\nCOMPARISON OF OTTO CYCLE, DIESEL CYCLE AND DUAL CYCLE EFFICIENCY UNDER SAME MAXIMUM PRESSURE AND HEAT INPUT\n")
...
Constant_data = [["Maximum pressure",p_max],["Adiabatic constant",gamma]]

#FIXED DATA
Fixed_data = [["Minimum pressure",p_min],["Compression Ratio of Otto cycle",r],["Maximum Volume",v_max],]
...
text(v3 - 0.004, p3 + 5000, '3', fontsize=12)
text(v4 + 0.0006, p4 - 45000, '4', fontsize=12)
...
text(v2d - 0.006, p2d, '2d', fontsize=12)
text(v3d + 0.002, p3d + 5000, '3d', fontsize=12)
text(v4d + 0.0006, p4d + 16000, '4d', fontsize=12)
